...
import com.tokbox.otsdkwrapper.listeners.*;
import com.tokbox.otsdkwrapper.screensharing.ScreenSharingCapturer;
import com.tokbox.otsdkwrapper.screensharing.ScreenSharingFragment;
import com.tokbox.otsdkwrapper.signal.SignalInfo;
import com.tokbox.otsdkwrapper.signal.SignalProtocol;
import com.tokbox.otsdkwrapper.utils.*;
...
public class OTWrapper {
     ...
     */
    public void addSignalListener(String signalName, com.tokbox.otsdkwrapper.listeners.SignalListener listener) {
        if (mSession != null) {
     ...
     * @param listener   Listener to be removed.
     */
    public void removeSignalListener(String signalName, com.tokbox.otsdkwrapper.listeners.SignalListener listener) {
        if (mSession != null) {
