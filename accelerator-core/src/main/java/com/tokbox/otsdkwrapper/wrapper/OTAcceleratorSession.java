package com.tokbox.otsdkwrapper.wrapper;
...
import com.tokbox.otsdkwrapper.GlobalLogLevel;
import com.tokbox.otsdkwrapper.signal.SignalInfo;
import com.tokbox.otsdkwrapper.signal.SignalProcessorThread;
import com.tokbox.otsdkwrapper.signal.SignalProtocol;
import com.tokbox.otsdkwrapper.utils.Callback;
import com.tokbox.otsdkwrapper.utils.LogWrapper;
import com.tokbox.otsdkwrapper.utils.ThreadPool;
...
public class OTAcceleratorSession extends Session {
    ...
    private ConcurrentHashMap<String, ArrayList<com.tokbox.otsdkwrapper.listeners.SignalListener>>
            mSignalListeners =
    ...
    public void addSignalListener(String signalName,
                                  com.tokbox.otsdkwrapper.listeners.SignalListener listener) {
        LOG.d(LOG_TAG, "Adding Signal Listener for: ", signalName);
        if (mSignalThreadPool == null) {
            mSignalThreadPool = new ThreadPool();
        }
        ArrayList<com.tokbox.otsdkwrapper.listeners.SignalListener> perNameListeners =
     ...
     */
    public void removeSignalListener(com.tokbox.otsdkwrapper.listeners.SignalListener listener) {
    ...
    private void dispatchSignal(ArrayList<com.tokbox.otsdkwrapper.listeners.SignalListener> listeners,
                                final SignalInfo signalInfo, boolean global) {
        if (listeners != null) {
            Iterator<com.tokbox.otsdkwrapper.listeners.SignalListener> listenerIterator =
                    listeners.iterator();
            while (listenerIterator.hasNext()) {
                LOG.d(LOG_TAG, "Starting thread to process: ", signalInfo.mSignalName,
                        " : ", signalInfo.mData);
                final com.tokbox.otsdkwrapper.listeners.SignalListener listener =
